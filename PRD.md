...
The database is seeded from the aggregated [EU DSA VLOP transparency reports](https://transparency.dsa.ec.europa.eu/) (`vlop-dsa.json`) — content-moderation statistics for 25 designated VLOP/VLOSE services for H1 2026, following tables 3–11 of the DSA Implementing Regulation template.
