...
Resource scoping:
  ...
  dsa-research-pp-cli sync

  # Sync specific resources only
  dsa-research-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  dsa-research-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  dsa-research-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  dsa-research-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  dsa-research-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/dsa-research-pp-cli/data.db)")
...
func resourceSupportsPagination(resource string) bool {
	switch resource {
	case "dsa-vlop-transparency-jobs":
		return true
	}
	return false
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"dsa-vlop-transparency-api":     "/api",
		"dsa-vlop-transparency-jobs":    "/api/jobs",
		"dsa-vlop-transparency-version": "/version",
		"explore":                       "/api/explore/options",
		"fields":                        "/api/fields",
		"healthz":                       "/healthz",
