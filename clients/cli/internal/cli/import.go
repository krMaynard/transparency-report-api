...
but do not stop the import.`,
  ...
  dsa-research-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  dsa-research-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | dsa-research-pp-cli import <resource> --input -`,
