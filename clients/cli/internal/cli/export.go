...
large datasets as it has no memory pressure.`,
  ...
  dsa-research-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  dsa-research-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  dsa-research-pp-cli export <resource> --format jsonl | jq '.id'`,
