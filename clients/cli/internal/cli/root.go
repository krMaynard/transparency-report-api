...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "dsa-research-pp-cli",
		Short: "Manage dsa-research resources via the dsa-research API",
		Long: `Manage dsa-research resources via the dsa-research API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'dsa-research-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("dsa-research-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'dsa-research-pp-cli profile list')")
	...
	rootCmd.AddCommand(newDsaVlopTransparencyJobsCmd(flags))
	rootCmd.AddCommand(newExploreCmd(flags))
	rootCmd.AddCommand(newPortalCmd(flags))
	...
	rootCmd.AddCommand(newDsaVlopTransparencyApiPromotedCmd(flags))
	rootCmd.AddCommand(newDsaVlopTransparencyAuthPromotedCmd(flags))
	rootCmd.AddCommand(newDsaVlopTransparencyVersionPromotedCmd(flags))
	rootCmd.AddCommand(newFieldsPromotedCmd(flags))
	rootCmd.AddCommand(newHealthzPromotedCmd(flags))
	rootCmd.AddCommand(newMetricsPromotedCmd(flags))
	rootCmd.AddCommand(newOverviewPromotedCmd(flags))
	rootCmd.AddCommand(newQueryPromotedCmd(flags))
	rootCmd.AddCommand(newReadyzPromotedCmd(flags))
	rootCmd.AddCommand(newSchemaPromotedCmd(flags))
	rootCmd.AddCommand(newStaticPromotedCmd(flags))
	rootCmd.AddCommand(newTablesPromotedCmd(flags))
