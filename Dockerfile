...
RUN python seed.py --source data/vlop-dsa.json --gr-source data/google-government-removals.json --apple-source data/apple-transparency.json --github-source data/github-transparency.json --db "$DB_PATH"
