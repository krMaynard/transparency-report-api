...
RUN python seed.py --source data/vlop-dsa.json --gr-source data/google-government-removals.json --apple-source data/apple-transparency.json --github-source data/github-transparency.json --snap-source data/snap-transparency.json --india-source data/india-it-rules.json --korea-source data/korea-transparency.json --taiwan-source data/taiwan-anti-fraud.json --db "$DB_PATH"
